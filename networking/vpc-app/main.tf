...
module "vpc_network_acls" {
  source = "git::git@github.com:gruntwork-io/module-vpc.git//modules/vpc-app-network-acls?ref=v0.6.0"
...
module "mgmt_vpc_peering_connection" {
  source = "git::git@github.com:gruntwork-io/module-vpc.git//modules/vpc-peering?ref=v0.6.0"
...
module "dns_mgmt_to_app" {
  source = "git::git@github.com:gruntwork-io/module-vpc.git//modules/vpc-dns-forwarder?ref=v0.6.0"
